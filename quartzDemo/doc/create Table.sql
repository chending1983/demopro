...
CREATE TABLE `SYS_JOB` (
  ...
  `INVOKE_TARGET` varchar(500) COLLATE utf8mb4_bin NOT NULL,
  `CRON_EXPRESSION` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `MISFIRE_POLICY` varchar(20) COLLATE utf8mb4_bin DEFAULT NULL,
  `CONCURRENT` char(1) COLLATE utf8mb4_bin DEFAULT NULL,
...
CREATE TABLE `SYS_JOB_LOG` (
  `JOB_LOG_ID` int(20) NOT NULL AUTO_INCREMENT,
  `JOB_NAME` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `JOB_GROUP` varchar(64) COLLATE utf8mb4_bin NOT NULL,
  `INVOKE_TARGET` varchar(500) COLLATE utf8mb4_bin NOT NULL,
  `JOB_MESSAGE` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL,
  `STATUS` char(1) COLLATE utf8mb4_bin DEFAULT NULL,
  `EXCEPTION_INFO` blob,
  `CREATE_TIME` date DEFAULT NULL,
